            ...
            <div class="callout callout-info mt-2">
                <div class="row">
                    ...
                    <div class="col-md-6  mt-2">
                        <h5><i class="nav-icon fa fa-user-plus"></i> Add Job Type</h5>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-xl-12">
            <div class="card" style="border-radius: 15px;">
                ...
                @endif
                    ...
                    <form action="{{ route('JobType.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="name"
                                    ...
                                    placeholder="Job Type" value="{{ old('name') }}" />
                                @error('name')
