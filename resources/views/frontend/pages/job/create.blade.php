                        ...
                        <div class="row align-items-center pt-2 pb-1">
                            ...
                            <div class="col-md-10 pe-5">
                                <select name="job_nature"
                                    class="form-control form-control-lg @if ($errors->has('job_nature')) is-invalid @elseif(old('job_nature')) is-valid @endif">
                                    <option value="">Select Job Nature</option>
                                    <option value="Full Time" @if (old('job_nature') == 'Full Time') selected @endif>Full Time
                                    </option>
                                    <option value="Part Time" @if (old('job_nature') == 'Part Time') selected @endif>Part Time
                                    </option>
                                    <option value="Remote" @if (old('job_nature') == 'Remote') selected @endif>Remote
                                    </option>
                                </select>
                                @error('job_nature')
                                <div id="validationServerUsernameFeedback" class="invalid-feedback">
