            ...
            <div class="callout callout-info mt-2">
                <div class="row">
                    ...
                    <div class="col-md-6  mt-2">
                        <h5><i class="nav-icon fa fa-user-plus"></i>Edit Product</h5>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="title"
                                    ...
                                    placeholder="Product Title" value="{{ old('title') ?? $product->title }}" />
                                @error('title')
                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="discount"
                                    ...
                                    placeholder="Product Discount" value="{{ old('discount') ?? $product->discount }}" />
                                @error('discount')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-10 pe-5">
                                <div class="card card-outline card-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <textarea id="summernote" name="content_details"> {{ old('address') ?? $product->description }}</textarea>
                                    </div>
                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-1">
                                ...
                                <img class="w-15" id="newImg" height="50" style="border-radius: 5px" src="{{ asset($product->image ? $product->image : 'images/default.jpg') }}" />
                            ...
                            <div class="col-md-9 pe-5">
                                <div class="custom-file">
                                    ...
                                    @enderror
                                    <input type="hidden" name="old_photo_path" value="{{ $product->image }}">
